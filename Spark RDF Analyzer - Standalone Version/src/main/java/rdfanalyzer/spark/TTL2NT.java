...
public class TTL2NT {
	...
	public static DataFrame main() throws Exception {
		...
		List<String> prefixList = prefixes.toJavaRDD()
...
//				"<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>");
		...
		DataFrame rows = WebService.sqlContext
				.sql("Select * from Graph WHERE Graph.subject<>'@prefix'");
		...
		WebService.sqlContext.udf().register("replacePrefix", replacePrefix,
