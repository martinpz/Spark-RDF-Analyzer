...
public class InDegree {
	public static String main(String[] args) throws Exception {
	   ...
	   DataFrame predicatesFrame = WebService.sqlContext.sql("SELECT "+args[1]+"(degree) FROM (SELECT object, COUNT(predicate) AS degree FROM Graph"
		   		+ " GROUP BY object) MyTable1");
