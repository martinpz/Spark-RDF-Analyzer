...
/*
 * This class calculates node ranking for a given graph. Then saves it to parquet.
 */
public class CalculateRanking {
	public static String main(String[] args) throws Exception {
	    ...
	    */
	   DataFrame resultsFrame = WebService.sqlContext.sql("SELECT subject, COUNT(*) as nr FROM Graph GROUP BY subject");
