...
/*
 * This class converts a graph from Turtle to nTripple format and saves it to parquet.
 */
public class TTL2NTV2 {
	...
	public static String main(String Input,String Name) throws Exception
	{
		 ...
		 * Read Prefixes
		 */
		 JavaRDD<RDFgraph> RDF1 = WebService.ctx.textFile(Input+"/*",18).map(
		 ...
		 DataFrame prefixesFrame = WebService.sqlContext.sql("SELECT subject,predicate,object FROM Prefixes Where subject NOT LIKE 'E'");
