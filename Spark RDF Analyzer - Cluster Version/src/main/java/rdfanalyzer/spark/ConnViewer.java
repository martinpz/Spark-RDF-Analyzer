...
/*
 * This is the main class of Connectivity Viewer module
 * It comunicates with other modules and calculates connections based on user parameters.
 */
...
public class ConnViewer {
	...
	public static void main(String startN, String endN, String graphName, String Predicates, String searchPattern)
	{
	    ...
	    * In addition check if the maximum number of results is not exteeded.
	    */
	...
	/*
	 * This method calculates a single pattern.
	 * If it is an output pattern then it forwards the result to adapter.
	 */
	...
	public static String preprocess(String graphName, String Predicates)
	{
		...
		if(list.length>1)
		{
		   ...
		   DataFrame predicatesFrame = WebService.sqlContext.sql("SELECT subject, predicate, object FROM Graph WHERE "+Condition);
