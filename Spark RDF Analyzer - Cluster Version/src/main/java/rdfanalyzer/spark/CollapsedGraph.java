...
/*
 * This class calculates Collapsed Chord Data and formats them for required output Chord or Table.
 */
public class CollapsedGraph {
	 ...
	 */
	  ...
	  */
	 DataFrame predicatesFrame = WebService.sqlContext.sql("SELECT t2o AS s, t1p AS p, t4o AS o, Count(*) AS nr FROM (SELECT t1.subject AS t1s, t2.object AS t2o, t1.predicate AS t1p, t1.object AS t1o FROM Graph t1, Graph t2"
	 ...
	 /*
	  * Merge Edgefinder data and format output results.
	  * Based on if output is table or chart it is returned into different formats.
	  */
	   ...
	   else
	   {
		   ...
		   int[][] matrix = new int[classNames.size()][classNames.size()];
			...
			for(CollapsedEntry objEntry:cachedData)
			{
				...
				matrix[ArrayUtils.indexOf(classNamesArray, class1)][ArrayUtils.indexOf(classNamesArray, class2)] += Integer.parseInt(Long.toString(nrEntries)); 
			}
	 ...
	 /*
	  * This method generates a row for given class groups, predicate and sum of nr of occurences.
	  */
	 public static String generateRow(Set<String> subjects, String predicate, Set<String> objects, long sum,String Type)
	 {
		 String result = "";
		 if(Type.equals("Table"))
		  {
			 ...
			 {
				 strSubjects += "<span data-toggle=\"tooltip\" title=\""+s+"\">"+Configuration.shortenURI(s)+"</span><br>";
			 }
			 
			 for(String o : objects)
			 {
				 strObjects += "<span data-toggle=\"tooltip\" title=\""+o+"\">"+Configuration.shortenURI(o)+"</span><br>";
			 }
			 
			 result ="<tr><td>"+strSubjects+"</td><td><span data-toggle=\"tooltip\" title=\""+predicate+"\">"+Configuration.shortenURI(predicate)+"</span></td><td>"+strObjects+"</td><td>"+Long.toString(sum)+"</td></tr>";
			 return result;
		  }
		 else
		 {
	...
	/*
	 * This method offers partial reading of results when chord diagram is clicked.
	 */
	 public static String partialRead(String inputSubject)
		{
		 ...
		 result = "<table class=\"table table-striped\">";
		 result += "<thead><tr><th colspan=\"4\" style=\"text-align: center;\"><b>Class: "+inputSubject+"</b></th></tr>";
		   result += "<thead><tr><th style=\"text-align: center;\">Subject</th><th style=\"text-align: center;\">Predicate</th><th style=\"text-align: center;\">Object</th><th style=\"text-align: center;\">Nr. of occurencies</th></tr></thead>";
