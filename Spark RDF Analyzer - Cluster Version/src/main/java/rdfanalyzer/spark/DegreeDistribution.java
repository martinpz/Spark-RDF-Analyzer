...
public class DegreeDistribution {
	 ...
	 */
	DataFrame resultsFrame = WebService.sqlContext.sql("SELECT degree, COUNT(degree) AS instances FROM (SELECT subject, COUNT(predicate)"
	...
	if(args[1].equals("Table"))
	   {
		   ...
		   for(Row r : resultRows)
		   {
			   ...
			   result +="<tr><td>"+Long.toString(r.getLong(0))+"</td><td>"+Long.toString(r.getLong(1))+"</td></tr>";
		   }
		   result +="</table>";
	   }
