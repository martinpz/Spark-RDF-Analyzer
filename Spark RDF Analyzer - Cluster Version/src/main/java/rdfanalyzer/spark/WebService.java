...
import org.apache.spark.sql.SQLContext;
 ...
 /*
  * This class is the REST web service which handles front end request by calling the desired module with specified parameters.
  */
@Path("/ALL")
public class WebService {
 
	public static Configuration configuration = new Configuration();
	public static SparkConf sparkConf = SparkConfigurationHelper.getConfiguration();
	public static JavaSparkContext ctx = new JavaSparkContext(sparkConf);
	public static SQLContext sqlContext = new SQLContext(ctx);
	public static ClassLoader classLoader = WebService.class.getClassLoader();
	...
	public String getMsgg(@PathParam("inputPath") String inputPath,@PathParam("inputName") String inputName,@PathParam("inputFormat") boolean inputFormat) {
		String objResponse="";
		try {
	...
	public String getMsg(@PathParam("DataSet") String dataSet) {
		...
		try {
			...
			objResponse = "Calculationd Failed.<br>  "+e.getMessage(); 
		}
	...
	public String getMsg6(@PathParam("DataSet") String dataSet,@PathParam("Type") String Type) {
	...
	public String getMsg14(@PathParam("DataSet") String dataSet,@PathParam("UserInput") String userInput,@PathParam("Type") String Type) {
	...
	public String getMsg16(@PathParam("DataSet") String dataSet,@PathParam("Node1") String startN,@PathParam("Node2") String endN,@PathParam("Predicates") String Predicates,@PathParam("Pattern") String Pattern) {
