...
public class GetClasses {
 ...
 public static String main(String[] args) throws Exception {
	  ...
	  */
	 DataFrame resultsFrame = WebService.sqlContext.sql("SELECT DISTINCT object FROM Graph WHERE predicate='<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'");
	 
	 /*
	  * Format output results. Based if output is table or chart it is returned into different formats.
	  */   
	 ...
	 if(args[1].equals("Normal"))
	 {
	   ...
	   {
		   result +="<tr><td data-toggle=\"tooltip\" title=\""+r.getString(0)+"\">"+Configuration.shortenURI(r.getString(0))+"</td></tr>";
	   }
	   result +="</table>";
	   }
