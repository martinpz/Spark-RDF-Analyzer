...
/*
 * This class is a helper for Connectivity Viewer module
 * It generates the queries for each pattern and lists where the output patterns and all paterns are noted.
 */
...
public class ConnViewerHelper {
	...
	{
		strQuery01 = "SELECT subject, predicate, object FROM "+graphName+" WHERE subject = '"+startN+"' AND object = '"+endN+"'";
		strQuery02 = "SELECT subject, predicate, object FROM "+graphName+" WHERE subject = '"+endN+"' AND object = '"+startN+"'";
		strQuery03 = "SELECT subject, predicate, object FROM "+graphName+" WHERE subject = '"+startN+"' AND object != '"+startN+"' AND object NOT LIKE '\"%'";
		strQuery04 = "SELECT subject, predicate, object FROM "+graphName+" WHERE subject = '"+endN+"' AND object != '"+endN+"' AND object NOT LIKE '\"%'";
		strQuery05 = "SELECT subject, predicate, object FROM "+graphName+" WHERE object = '"+endN+"' AND subject != '"+endN+"'";
		strQuery06 = "SELECT subject, predicate, object FROM "+graphName+" WHERE object = '"+startN+"' AND subject != '"+startN+"'";
		...
		strQuery15 = "SELECT tbl03.subject AS subject1, tbl03.predicate AS predicate1, tbl03.object AS object, "+graphName+".predicate as predicate2, "+graphName+".object as object2 FROM tbl03, "+graphName+" WHERE tbl03.object = "+graphName+".subject AND "+graphName+".object != tbl03.subject";				
		strQuery16 = "SELECT tbl04.subject AS subject1, tbl04.predicate AS predicate1, tbl04.object AS object, "+graphName+".predicate as predicate2, "+graphName+".object as object2 FROM tbl04, "+graphName+" WHERE tbl04.object = "+graphName+".subject AND "+graphName+".object != tbl04.subject";	
		strQuery17 = "SELECT "+graphName+".object AS object1, "+graphName+".predicate AS predicate1, "+graphName+".subject AS subject, tbl05.predicate as predicate2, tbl05.object as subject2 FROM "+graphName+", tbl05 WHERE "+graphName+".subject = tbl05.subject AND tbl05.object != "+graphName+".object";
		strQuery18 = "SELECT tbl06.object AS subject1, tbl06.predicate AS predicate1, tbl06.subject AS subject, "+graphName+".predicate as predicate2, "+graphName+".object as object1 FROM tbl06, "+graphName+" WHERE tbl06.subject = "+graphName+".subject AND "+graphName+".object != tbl06.object";		
