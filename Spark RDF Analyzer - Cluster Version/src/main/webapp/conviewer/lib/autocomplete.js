function checkNode(Node)
{
	document.getElementById("myModalLabel").setAttribute('nodeName', Node );
     ...
     xhttp.onreadystatechange = function() {
      ...
      {
    	   xhttp.open("GET", "http://isydney.informatik.uni-freiburg.de:8080/spark-rdfanalyzer2/rest/ALL/autoComplete/"+selectedGraphValue+"/"+inputNode+"/"+Node, true);
     	   xhttp.send();  
      }
}
...
function startJob()
{
  ...
  xhttp.open("GET", "http://isydney.informatik.uni-freiburg.de:8080/spark-rdfanalyzer2/rest/ALL/connViewer/"+Node1+"/"+Node2+"/"+selectedGraphValue+"/"+Predicate+"/"+Pattern, true);
  xhttp.send();
...
function getResult()
{
  ...
  xhttp.open("GET", "http://isydney.informatik.uni-freiburg.de:8080/spark-rdfanalyzer2/rest/ALL/connViewerResult", true);
  xhttp.send();
