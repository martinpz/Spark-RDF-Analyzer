...
public class WebService {
	...
	public Response getDirectNeighbors(@PathParam("graph") String graph,
			...
			@DefaultValue("1") @QueryParam("distance") int distance) throws UnsupportedEncodingException {
		...
		JSONObject neighbors = Neighborhood.getNeighbors(graph, centralNode, numNeighbors, distance);
