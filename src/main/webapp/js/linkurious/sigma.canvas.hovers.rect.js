...
(function (undefined) {
     ...
     */
    sigma.canvas.hovers.rect = function (node, context, settings) {
        var x,
            y,
            w,
            h,
            ...
            labelX,
            labelY,
            realLabel = node.data.name, // node.label
            lines,
            baseX,
            baseY,
        ...
        // Display the label:
        if (realLabel && typeof realLabel === 'string') {
            ...
            var labelWidth = sigma.utils.canvas.getTextWidth(context,
                    settings('approximateLabelWidth'), fontSize, lines[0]),
                labelOffsetX = 0, //-labelWidth / 2,
            ...
            for (var i = 0; i < lines.length; ++i) {
                context.fillText(lines[i], baseX, baseY + (i - extraOffsetY) * (fontSize + 1));

                // Show at most three lines of text.
                if (i == 2) break;
            }
        }
